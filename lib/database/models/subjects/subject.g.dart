...
extension SubjectQueryFilter
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> colorValueIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> colorValueIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> iconCodePointIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> iconCodePointEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'iconCodePoint',
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> iconCodePointLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> iconCodePointBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension SubjectQuerySortBy on QueryBuilder<Subject, Subject, QSortBy> {
  ...
  QueryBuilder<Subject, Subject, QAfterSortBy> sortByIconCodePoint() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCodePoint', Sort.asc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> sortByIconCodePointDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SubjectQuerySortThenBy
  ...
  QueryBuilder<Subject, Subject, QAfterSortBy> thenByIconCodePoint() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCodePoint', Sort.asc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> thenByIconCodePointDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCodePoint', Sort.desc);
    });
  }
...
extension SubjectQueryWhereDistinct
  ...
  QueryBuilder<Subject, Subject, QDistinct> distinctByIconCodePoint() {
    return QueryBuilder.apply(this, (query) {
